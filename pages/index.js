...
export default function Home() {
  ...
  const onMintPressed = async (e) => {
    ...
    await nftContract.methods.mint(count).send({ from: walletAddress, value: total, gas: 3000000 })
  ...
  return (
    <>
      <Head>
        <title>ARC Token</title>
        <meta name="description" content="Bird Pass NFT Dapp" />
          ...
          <div className='flex-grow'>
            <div className='flex'>
              <Link className='w-min-content' href='/' passHref>
                <a className='flex'>
                  <img alt='' src='/images/CryptoARC.png' className='h-[40px]' />
                  <p className='h-7 px-2 pt-1 pb-1 rounded uppercase text-lg font-black
            ...
            <ul className='flex space-x-2'>
              ...
              <li>
                {walletAddress.length > 0 ? (
                  <div className='px-4 bg-opacity-20 text-gray-900 items-center relative h-7 tracking-wider pt-0.5 first::pt-0 duration-500 text-sm md:text-base padding-huge opacity-100 hover:bg-opacity-70 rounded flex justify-center flex-row border border-bluee hover:shadow-green-500/20 cursor-pointer'
                  >
              ...
              <li className='hidden md:flex'>
                <a className='bg-opacity-20 text-black opacity-80 items-center relative h-7 tracking-wider pt-0.5 first::pt-0 uppercase text-2xs font-500 padding-huge bg-white duration-200 px-4 hover:bg-opacity-70 rounded flex justify-center flex-row transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110' href='https://twitter.com/' target='_blank' rel='noreferrer'>
              ...
              {/* Discord Icon */}
              <li className='hidden md:flex'>
                <p className='bg-opacity-20 text-black opacity-80 items-center relative h-7 tracking-wider pt-0.5 first::pt-0 uppercase text-2xs font-500 padding-huge bg-white duration-200 px-4 hover:bg-opacity-70 rounded flex justify-center flex-row cursor-pointer transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110'>
      ...
      <section className="flex items-center justify-center bg-pattern py-12 px-5 overflow-hidden relative z-10" id="">
        <div className="">
          ...
          <div className="flex flex-col items-center justify-center md:flex-row md:items-center md:justify-between text-slate-900 -mx-4">
            ...
            <div className="w-full md:w-1/2 xl:w-6/12 px-4">
              <div className="max-w-[570px] mb-12 md:mb-0">
                <p className="text-3xl text-center md:text-6xl font-extrabold text-body-color leading-relaxed text-transparent bg-clip-text bg-gradient-to-tl stand__out__text from-bluee via-sky-500 to-greenn uppercase mb-3 md:mb-8">
                  ARC Token
                </p>
                ...
                <div className='flex flex-col items-center justify-center text-black'>
                  ...
                  <div className='mb-4 bg-pattern flex items-center justify-between rounded-md w-11/12 mx-auto p-2 border-2 border-bluee transition ease-in-out duration-500'>
                    <p className='font-bold'>Price Per Mint:</p>
                    <p>0.00 ETH</p>
                  </div>
                ...
                {walletAddress.length > 0 ? (
                  <div className='flex flex-col'>
                    <div className='flex items-center justify-between px-16 sm:px-24 m-4'>
                      <button className='button w-10 h-10 flex items-center justify-center text-white text-base hover:shadow-lg bg-background font-bold rounded-md border border-opacity-80 border-cyan-600'
                      ...
                      <button className="button w-10 h-10 flex items-center justify-center text-white text-2xl hover:shadow-lg bg-background font-bold rounded-md border border-opacity-80 border-cyan-600"
                    ...
                    <div className='flex items-center justify-center'>
                      <button
                        className='text-lg font-semibold uppercase font-base text-black px-12 py-2 tracking-wide bg-gradient-to-tl from-greenn hover:from-cyan-200 hover:to-cyan-500 to-bluee rounded-md hover:shadow-green-500/20'
                        // onClick={mintPass}
            ...
            <div className="w-full md:w-1/2 xl:w-6/12 px-4">
              <div className="relative rounded-md p-8 shadow-md">
                <video autoPlay loop muted poster='/images/CryptoARC.png' className='w-[660px] vid hidden md:block'>
                  <source src='/images/CryptoARC.png' />
                </video>
                <img src='/images/CryptoARC.png' alt='pass image' className='w-[450px] md:hidden flex items-center justify-center' />
              </div>
            </div>
          </div>
        </div>
