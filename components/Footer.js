...
export default function Footer() {
  return (
    <footer className='py-6 h-28 md:px-8 px-5 pt-5 pb-3 bg-gray-900 border-t border-gray-900/75 flex items-center justify-between'>
      <p>© 2022 - ARC TOKEN</p>
      <div>
        <ul className='flex items-center justify-center space-x-2 md:space-x-4'>
          {/* Twitter Icon */}
          <li className=''>
            <a className='bg-opacity-20 items-center relative h-7 tracking-wider pt-0.5 first::pt-0 uppercase text-2xs font-500 padding-huge  duration-200 px-4 flex justify-center flex-row transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110' href='https://twitter.com/' target='_blank' rel='noreferrer'>
          ...
          {/* Discord Icon */}
          <li className=''>
            <a className='bg-opacity-20 items-center relative h-7 tracking-wider pt-0.5 first::pt-0 uppercase text-2xs font-500 padding-huge  duration-200 px-4 flex justify-center flex-row transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110' href='https://discord.com/' target='_blank' rel='noreferrer'>
